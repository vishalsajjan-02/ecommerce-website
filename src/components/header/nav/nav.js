...
const Nav = (props) => {
    ...
    useEffect(() => {
        // Ensure navData is set only if props.data is defined and is an array
                                ...
                                <ul className='list list-inline mb-0'>
                                        ...
                                        navData.map((item, index) => (
                                            <li className='list-inline-item' key={index}>
                                                ...
                                                {item.items && item.items.length > 0 && (
                                                    <div
                                                        className={`dropdown_menu ${openDropdownMenu && openDropdownMenuIndex === index ? 'open' : ''
                                                            }`}
                                                    >
                                                        <ul>
                                    ...
                                    <li className='list-inline-item position-static'>
                                        <Button onClick={() => setOpenMegaMenu(!openMegaMenu)}>
                                            <Link>
                                                Shop <KeyboardArrowDownIcon className={`${openMegaMenu ? 'rotateIcon' : ''}`} />
                                            </Link>
                                        </Button>
